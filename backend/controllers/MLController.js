...
export const createMLData = async(req, res) =>{
    try{
       ...
       const indicadores = {
        ...
        deuda_patrimonio: parseFloat(parseFloat(req.body.total_pasivos)/ (parseFloat(req.body.total_activos)-parseFloat(req.body.total_pasivos))),   //Total Pasivos / (Total activo -Total Pasivo)
        rotacion_inventario: parseFloat(parseFloat(req.body.costo_ventas)/ parseFloat(inventario_promedio) ), //COGS / Inventario_Promedio
        rotacion_cuentas: parseFloat(parseFloat(req.body.ventas_credito)/parseFloat(req.body.cuentas_por_cobrar)),  //Ventas_a_Crédito / Cuentas_por_Cobrar_Promedio
        ...
        margen_neto: parseFloat(parseFloat(req.body.utilidad_neta)/parseFloat(req.body.ventas_totales)),  //Utilidad_Neta / Ventas_Totales
        rendimiento_activos: parseFloat(parseFloat(req.body.utilidad_neta)/parseFloat(req.body.total_activos)),  //Utilidad_Neta / Activo_Total
        rendimiento_patrimonio: parseFloat(parseFloat(req.body.utilidad_neta)/parseFloat(req.body.patrimonio)), //Utilidad_Neta / Patrimonio
